...
const COLUMNAS: { campo: string; titulos: string[]; ejemplo: string | number }[] = [
  ...
  { campo: 'costo', titulos: ['costo', 'costo unitario', 'valor compra', 'precio compra', 'precio de compra', 'valor unt', 'valor unitario', 'valor und'], ejemplo: 38000 },
  ...
  { campo: 'existencias', titulos: ['existencias', 'stock', 'cantidad', 'inventario', 'unidades', 'saldo', 'und'], ejemplo: 24 },
